...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="images/all.jpg" alt="Third slide">
            <div class="text-center banner carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="images/pie_slides.jpg" alt="First slide">
            <div class="text-center banner carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="images/ellen_slides.jpg" alt="Third slide">
            <div class="text-center banner carousel-caption d-none d-md-block">
            </div>
        </div>
    </div>

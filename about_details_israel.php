            ...
            <div class="col-lg-8 col-md-12 ml-auto">
                <div class="d-flex py-4">
                    <div class="col-lg-2 mr-5">
                        <img style="" src="images/israel.jpg" class="details-img">
                    </div>
                    <div class="col-lg-6">
                        <h4 class="text-capitalize font-weight-bold">
                            Adv. Israel IRAZIRIKANA
                        </h4>
                        <div>
                            Partner
                        </div>
                        <div>
                            <span>
                                <a href="" style="text-decoration:none;">
                                    irazirikana@amilex.rw
                                </a>
                            </span>
                        </div>
                        <div class="mt-4">
                            Phone Number:+250 788 850 278
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-md-12 ml-auto">
                ...
                <div style="width: 94%; !important;" class="tab-content mx-5 my-5" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-overview" role="tabpanel"
                        ...
                        <p>Adv. Israel IRAZIRIKANA is a Partner at Amilex chambers. He joined Amilex in 2017 as a senior
                            associate and was promoted to Partner in 2021.<br>
                            <br> He is a member of the Rwanda Bar
                            Association
                            and the East Africa Law Society. Adv. Israel holds a Master’s degree in business law, a
                            Master’s degree in procurement and supply chain management, a Bachelor’s degree in law,
                            and
                            a Postgraduate diploma in legal practice.<br>
                            <br> Prior to joining Amilex, Israel worked at the
                            Rwanda Revenue Authority as Legal Advisor to the Commissioner General, at Horizon Group
                            Ltd
                            as Legal Advisor, and as Contracts Manager at the National Bank of Rwanda. Adv. Israel
                            is
                            fluent in English, French, and Kinyarwanda, proficient in Kiswahili and has a good
                            command
                            of Portuguese.
                        </p>
                    </div>
                    <div class="tab-pane fade" id="nav-academic" role="tabpanel" aria-labelledby="nav-academic-tab">
                        <div class="o-layout-sub">
                            <ol>
                                <div class="col-lg-12">
                                    <li>LLM Business Law (University of Rwanda, 2022)</li>
                                    <li>MSc. Procurement and Supply Chain Management (Mt Kenya University, 2018)</li>
                                    <li>LLB Law (University of Rwanda, 2010)</li>
                                    <li>PGD Legal Practice (ILPD, 2019)</li>
                                </div>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="nav-member" role="tabpanel" aria-labelledby="nav-member-tab">
                        <div class="o-layout-sub">
                            <ol>
                                <div class="col-lg-12">
                                    <li>Rwanda Bar Association (since 2017)</li>
                                    <li>East Africa Law Society (since 2017)</li>
                                </div>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="nav-experience" role="tabpanel" aria-labelledby="nav-experience-tab">
                        <div class="o-layout-sub">
                            <ol>
                                <div class="col-lg-12">
                                    <li>
                                        Litigation representation of a foreign company versus the government, value of
                                        the case: 31 million USD
                                    </li>
                                    <li>
                                        Litigation representation of a local quasi-governmental owned company versus a
                                        foreign company, value of the case: 4 million USD
                                    </li>
                                </div>
                            </ol>
                        </div>

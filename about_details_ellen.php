            ...
            <div class="col-lg-8 col-md-12 ml-auto">
                <div class="d-flex py-4">
                    <div class="col-lg-2 mr-5">
                        <img style="" src="images/ellen.jpg" class="details-img">
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="col-lg-8 col-md-12 ml-auto">
                ...
                <div style="width: 94%; !important;" class="tab-content mx-5 my-5" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-overview" role="tabpanel"
                        ...
                        <p> Ms Ellen Musonera is a Legal Assistant at Amilex since 2015. She holds a Bachelor’s
                            degree in
                            Law from Kigali Independent University and a Postgraduate Diploma in legal practice from the
                            Institute of Legal Practice and Development.<br> Ms Ellen is a passionate lawyer with an eye
                            for
                            analytical detail. She assists the partners in their daily work. She is fluent in English
                            and Kinyarwanda. </p>
                    </div>
                        ...
                        <div class="o-layout-sub">
                            <ol>
                                <div class="col-lg-12">
                                    ...
                                    <li>PGD Legal Practice (ILPD, 2022)</li>
                                </div>
                            </ol>
                        </div>
                    </div>

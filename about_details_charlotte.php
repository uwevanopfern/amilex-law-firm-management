            ...
            <div class="col-lg-8 col-md-12 ml-auto">
                <div class="d-flex py-4">
                    <div class="col-lg-2 mr-5">
                        <img style="" src="images/Umutoni.jpeg" class="details-img">
                    </div>
                    <div class="col-lg-6">
                        <h4 class="text-capitalize font-weight-bold">
                            Ms Charlotte U. OPPERMAN
                        </h4>
                        <div>
                            Legal Officer
                        </div>
            ...
            <div class="col-lg-8 col-md-12 ml-auto">
                ...
                <div style="width: 94%; !important;" class="tab-content mx-5 my-5" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-overview" role="tabpanel"
                        ...
                        <p>Ms Charlotte U. Opperman joined Amilex Chambers in July 2021 as a Legal Officer. Ms
                            Charlotte
                            holds a Master’s degree in International Economics and Business Law and a Bachelor’s degree
                            in law both from Kigali Independent University, and she is currently pursuing a
                            Post-graduate diploma in legal practice at the Institute of Legal Practice and Development.
                            <br><br>
                            She has extensive experience working with companies in the construction industry and the
                            agribusinesses projects. At Amilex Chambers, Ms Charlotte works in hands with the Partners
                            and assists in drafting and reviewing legal documents, preparation of litigation cases,
                            legal research, etc. Ms Charlotte speaks English and Kinyarwanda and she is fluent in French
                            and some Afrikaans
                        </p>
                    </div>
                    <div class="tab-pane fade" id="nav-academic" role="tabpanel" aria-labelledby="nav-academic-tab">
                        <div class="o-layout-sub">
                            <ol>
                                <div class="col-lg-12">
                                    <li>
                                        LLM International Economics and Business Law (Kigali Independent University,
                                        2019)
                                    </li>
                                    <li>
                                        LLB Law (Kigali Independent University, 2016)
                                    </li>

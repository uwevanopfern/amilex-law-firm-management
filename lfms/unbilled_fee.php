    ...
    <div class="page-content">
        <div class="col-xs-12 col-sm-12 col-md-4">
            <div class="widget-header"  style="background-color:  #ff9999;">
                <h4 class="widget-title">Add new unbilled fee note</h4>
                <br><br><br><hr>
                ...
                if (isset($_POST['save'])) {
                    ...
                    $unbill_date = mysqli_real_escape_string($db,$_POST['unbill_date']);
                    ...
                    elseif (empty($paid)) {
                        ...
                        $insert = "INSERT INTO `unbilled_fee` (`client_name`, `file_number`, `subject`, `date`, `total`, `paid`) VALUES ('".$client_names."', '".$file_no."', '".$subject."', '".$unbill_date."', '".$total."', '".$paid."')";
                ...
                <form class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                                <input type="date" name="unbill_date" class="form-control" />
                        </div>
                    </div>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                ...
                                $select = "SELECT * FROM unbilled_fee ORDER BY id DESC";
                            ...
                            <tr>
                                ...
                                <td class="hidden-480"><span class="label label-sm label-danger"><?php echo $subject;?></span></td>
                                ...
                                <td>
                                    <a href="edit_unbilled_fee.php?unbilled_fee_id=<?php echo $id?>" class="tooltip-success" data-rel="tooltip" title="Edit info">
                                        <span class="green">

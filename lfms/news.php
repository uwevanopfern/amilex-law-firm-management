    ...
    <div class="page-content">
        <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-2">
            <div class="widget-header" style="background-color:  #ff9999;">
                <h4 class="widget-title">Add news</h4>
                <br><br><br>
                <?php
...
if (isset($_POST['upload'])) {
    ...
    $avatar = mt_rand(100000, 999999) . $avatar;
    $loc_avatar = $_FILES['picture']['tmp_name'];

    move_uploaded_file($loc_avatar, "images/news/" . $avatar);

    $title = $_POST['title'];
    $content = $_POST['content'];

    // $upload_ = $object->upload_news($title, $source, $avatar, $content);

    $upload_ = "INSERT INTO `news` (`title`, `avatar`, `content`) VALUES ('" . $title . "', '" . $avatar . "', '" . $content . "')";

    $upload_OK = mysqli_query($db, $upload_);

    if ($upload_OK) {

        echo '<script>alert("News uploaded with success")</script>';
        ?>
        ...
        echo '<script>alert("Oops, Failed to upload news, Try again!")</script>';
    }
}
?>
    ...
    <div class="container-fluid">
        ...
        <div style="left: 8%;" class="col-lg-12 col-md-12 ml-auto">
            <h3 class="header smaller lighter blue">Data results of news portal added</h3>

            <div class="clearfix">
                <div class="pull-right tableTools-container"></div>
            </div>
            <div class="table-header">
                Edit some "news portal of your law firm"
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="edit_news.php?news_id=<?php echo $id; ?>"
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            ...
                                            <li>
                                                <a href="edit_news.php?news_id=<?php echo $id; ?>"

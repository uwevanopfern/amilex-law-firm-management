    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="widget-header"  style="background-color:  #ff9999;">
                <h4 class="widget-title">Add Case Category</h4>
                <br><br><br>
                <?php
                ...
                if (isset($_POST['add'])) {
                    ...
                    $insert = "INSERT INTO `category` (`name`, `description`) VALUES ('".$category_name."', '".$description."')";
                ...
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="form-field-1" name="category_name" placeholder="Enter name" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="form-field-2" name="description" placeholder="Description" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8">
                ...
                <div class="table-header">
                    Results for "Latest registered case of yours"
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        ...
                                        <a class="green" href="edit_case.php?case_id=<?php echo $case_id?>" title="Edit this case">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                ...
                                                <li>
                                                    <a href="edit_case.php?case_id=<?php echo $case_id?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">

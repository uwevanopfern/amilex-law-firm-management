    ...
    <div class="page-content">
        <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
            <div class="widget-header"  style="background-color:  #ff9999;">
                <h4 class="widget-title">print case bellow</h4>
                <br><br><hr>
                <div class="btn-toolbar">
                    <a titlt="print screen" alt="print screen" onclick="window.print();" target="_blank" style="cursor:pointer;border-radius: 4px;" class="btn btn-default">PRINT CASE</a>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">
                            Lead counsel was <strong><?php echo $leader;?></strong>
                        </h2>
                        <h3 style="font-size:16px;">
                            Date : <strong><?php echo $date;?></strong>
                        </h3>
                        <h3 style="font-size:16px;">
                            Case number : <strong><?php echo $case_no;?></strong>
                        </h3>
                        <h3 style="font-size:16px;">
                            File number : <strong><?php echo $file_number;?></strong>
                        </h3>
                        <h3 style="font-size:16px;">
                            Client : <strong><?php echo $urega;?></strong>
                        </h3>
                        <h3 style="font-size:16px;">

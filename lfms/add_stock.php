    ...
    <div class="page-content">
        <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
            <div class="widget-header" style="background-color:  #ff9999;">
                ...
                if (isset($_POST['add'])) {
                    ...
                    $qties = mysqli_real_escape_string($db, $_POST['qties']);
                    $minimum = mysqli_real_escape_string($db, $_POST['minimum']);
                    ...
                    if (empty($name)) {
                        ...
                        echo '<div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <span><strong>Oops, </strong>Quantity can not be empty</span>
                      </div>';
                    }
                    elseif (empty($minimum)) {
                        echo '<div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <span><strong>Oops, </strong>Minimum Quantity can not be empty</span>
                      </div>';
                    }elseif (empty($status)) {
                        echo '<div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        ...
                        echo '<div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <span><strong>Oops, </strong>Price can not be empty</span>
                      </div>';
                    } elseif (empty($date)) {
                        echo '<div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        ...
                        $select_name = "SELECT * FROM products WHERE name = '" . $name . "'";
                        ...
                        if ($count_name != 0) {
                            ...
                            $insert_products = "INSERT INTO `products` (`name`, `open_qty`, `minimum_qty`, `price`, `status`,`category`,`date`) VALUES ('" . $name . "', '" . $qties . "', '" . $minimum . "', '" . $price . "', '" . $status . "','" . $product_cat . "', '" . $date . "')";

                            $result_by_insert_products = mysqli_query($db, $insert_products);


                            if ($result_by_insert_products) {
                                ?>
                ...
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="form-field-1" name="name" placeholder="Product name"
                                   class="form-control"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Product
                            Qties </label>

                        <div class="col-sm-8">
                            <input type="text" id="form-field-2" name="qties" placeholder="Product quantities"
                                   class="form-control"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Minimum
                            Qties </label>

                        <div class="col-sm-8">
                            <input type="text" id="form-field-2" name="minimum" placeholder="Minimum quantities"
                                   class="form-control"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Total Cost </label>

                        <div class="col-sm-8">
                            <input type="text" id="form-field-2" name="price" placeholder="Total Cost"
                                   class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Product
                            Status </label>
                        <div class="col-sm-8">
                            <select class="form-control" name="status" id="form-field-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="product_cat" id="form-field-2">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            &nbsp; &nbsp; &nbsp;
                            <a href="add_stock.php" class="btn" type="reset">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="table-header">
                Edit some "stock products of your law firm"
            </div>
                    ...
                    while ($row_by_your_products = mysqli_fetch_array($result_by_your_products)) {
                        ...
                        <tr>
                            ...
                            <td class="hidden-480"><span
                                        class="label label-sm label-danger"><?php echo $open_qty; ?></span></td>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="green" href="edit_product.php?product_id=<?php echo $id; ?>"
                                       title="Edit this case">
                                        <i class="ace-icon fa fa-pencil-square-o bigger-130"></i>
                                    </a><!--

                                        <a class="red" href="#"  title="Delete this case">
